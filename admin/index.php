            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor ">
                        <a href="doctors.php" class="non-style-link-menu "><div><p class="menu-text">Add Doctors</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctors.php" method="post" class="header-search">
                                    ...
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Hospital centres" list="doctors">&nbsp;&nbsp;
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Quick access or Plan chart to Upcoming Appointments until a week<br>
                                        You can add,Remove centres in @vaccination centres.
                                    </p>
                                ...
                                <td>
                                    <p style="text-align:right;padding:10px;padding-right:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Upcoming Vaccine Sessions until Next <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    ...
                                    Quick access or Plan chart to Upcoming Sessions until a week<br>
                                    You can add,Remove Sessions in @Appointment for vaccine section.
                                    </p>
                                </td>
                            </tr>
                            <tr>
