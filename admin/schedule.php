            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" >
                        ...
                        <a href="?action=add-session&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="margin-left:25px;background-image: url('../img/icons/add.svg');">Add sessions</font></button>
                        </a>
                        </div>
                    </td>
                </tr>
                    ...
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                       ...
                       Hospital Centres:
                        ...
                        <select name="docid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Search Hospital centres around your locality</option><br/>
